...
def test_add_and_insert_transaction():
    ...
    transactions = functions.insert_transaction(
...
def test_modify_transaction():
    ...
    transactions = functions.remove_transaction_in_between_days(
    ...
    transactions = functions.replace_transaction_by_amount(
