...
class ExpenseService:
   ...
   def generate_random_expenses(self, number_of_expenses: int = 10):
      ...
      descriptions = ["food", "clothes", "rent", "utilities", "subscriptions", "Takeout"]
   ...
   def add_expense(self, expense_day, expense_amount, expense_type, store_undo_snapshot: bool = True):
   ...
   def filter_expenses_by_amount(self, amount: int):
      """
      Returns a list of expenses whose amount is greater than the given amount
